...
EOF
	...
	make -C $LINUX ARCH=${ARCH} CROSS_COMPILE=$TOOLS O=${BUILD}/kernel modules_install INSTALL_MOD_PATH="$DEST"

	# Install Kernel headers
	make -C $LINUX ARCH=${ARCH} CROSS_COMPILE=$TOOLS O=${BUILD}/kernel headers_install INSTALL_HDR_PATH="$DEST/usr/local"
